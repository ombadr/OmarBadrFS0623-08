...
console.log('Crew mass is: ' + crewMass);
...
if (crewMass > 1000) {
  ...
  console.log("Crtitial Load: Over 900")
...
const getRandomCharacter = () => {
  ...
  console.log('Name: ' + starWarsCharacters[randomIndex].name);
  console.log('Height: ' + starWarsCharacters[randomIndex].height);
  console.log('Mass: ' + starWarsCharacters[randomIndex].mass);
  console.log('Hair color: ' + starWarsCharacters[randomIndex].hair_color);
  console.log('Skin color: ' + starWarsCharacters[randomIndex].skin_color);
  console.log('Eye color: ' + starWarsCharacters[randomIndex].eye_color);
  console.log('Birth year: ' + starWarsCharacters[randomIndex].birth_year);
  console.log('Gender: ' + starWarsCharacters[randomIndex].gender);
}
